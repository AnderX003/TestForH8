    ...
    public static class Spring
    {
            ...
            float dampingRatio) // damping ratio of motion
        {
            ...
            if (dampingRatio > 1.0f + epsilon)
            {
                ...
                float zb = angularFrequency *
                           Mathf.Sqrt(dampingRatio * dampingRatio - 1.0f);
                float z1 = za - zb;
                float z2 = za + zb;
            ...
            else if (dampingRatio < 1.0f - epsilon)
            {
                ...
                float alpha = angularFrequency *
                              Mathf.Sqrt(1.0f - dampingRatio * dampingRatio);
                ...
                float expOmegaZetaSin_Over_Alpha =
            ...
            DampedSpringMotionParams parameters) // motion parameters to use
        {
            ...
            pPos = oldPos * parameters.posPosCoef + oldVel * parameters.posVelCoef +
                   equilibriumPos;
        ...
        public static void Calc(ref float position, ref float velocity,
            float equilibriumPosition, float deltaTime, float angularFrequency,
            float dampingRatio)
        {
            var motionParams =
                CalcDampedSpringMotionParams(deltaTime, angularFrequency, dampingRatio);
            UpdateDampedSpringMotion(ref position, ref velocity, equilibriumPosition,
                motionParams);
        }
        ...
        public static void Calc(ref Vector2 position, ref Vector2 velocity,
            Vector2 equilibriumPosition, float deltaTime, float angularFrequency,
            float dampingRatio)
        {
            var motionParams =
                CalcDampedSpringMotionParams(deltaTime, angularFrequency, dampingRatio);
            UpdateDampedSpringMotion(ref position.x, ref velocity.x,
                equilibriumPosition.x, motionParams);
            UpdateDampedSpringMotion(ref position.y, ref velocity.y,
                equilibriumPosition.y, motionParams);
        }
        ...
        public static void Calc(ref Vector3 position, ref Vector3 velocity,
            Vector3 equilibriumPosition, float deltaTime, float angularFrequency,
            float dampingRatio)
        {
            var motionParams =
                CalcDampedSpringMotionParams(deltaTime, angularFrequency, dampingRatio);
            ...
            UpdateDampedSpringMotion(ref position.y, ref velocity.y,
                equilibriumPosition.y, motionParams);
            UpdateDampedSpringMotion(ref position.z, ref velocity.z,
                equilibriumPosition.z, motionParams);
        }
        ...
        public static void Calc(ref Vector4 position, ref Vector4 velocity,
            Vector4 equilibriumPosition, float deltaTime, float angularFrequency,
            float dampingRatio)
        {
            var motionParams =
                CalcDampedSpringMotionParams(deltaTime, angularFrequency, dampingRatio);
            ...
            UpdateDampedSpringMotion(ref position.z, ref velocity.z,
                equilibriumPosition.z, motionParams);
            UpdateDampedSpringMotion(ref position.w, ref velocity.w,
                equilibriumPosition.w, motionParams);
        }
        ...
        public static void Calc(ref Quaternion position, ref Quaternion velocity,
            Quaternion equilibriumPosition, float deltaTime, float angularFrequency,
            float dampingRatio)
        {
            var motionParams =
                CalcDampedSpringMotionParams(deltaTime, angularFrequency, dampingRatio);
